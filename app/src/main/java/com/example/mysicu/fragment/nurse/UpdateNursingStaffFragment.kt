...
import com.example.mysicu.databinding.FragmentUpdateNursingStaffBinding
import com.example.mysicu.models.StaffModel
import com.example.mysicu.viewModels.UpdatingStaffViewModel
...
class UpdateNursingStaffFragment : Fragment() {

    private lateinit var mBinding: FragmentUpdateNursingStaffBinding
    private val args: UpdateNursingStaffFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        mBinding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_update_nursing_staff,
                container,
                false
            )
